...
if(isset($_POST['signupSubmit'])){
    ...
    if(!empty($_POST['first_name']) && !empty($_POST['last_name']) && !empty($_POST['email']) && !empty($_POST['phone']) && !empty($_POST['gender']) && !empty($_POST['DOB']) && !empty($_POST['location']) && !empty($_POST['skills']) && !empty($_POST['password']) && !empty($_POST['confirm_password'])){
    ...
    $redirectURL = ($sessData['status']['type'] == 'success')?'success.php':'register.php';
