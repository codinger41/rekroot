...
<!-- Mirrored from ocsolutions.co.in/html/jobportal/candidate-grid-view.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Jul 2017 20:48:01 GMT -->
<head>
<meta charset="utf-8"/>
				...
				<div class="col-md-9 col-sm-9 col-xs-12 padd0">
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="product-box candidate">
							<div class="image">
								<a href="candidate-grid-view.php">
									<img class="img-responsive" src="images/img1.jpg" alt="img1" title="img1"/>
								</a>	
								<div class="buttons">
									<div class="open-down">
							...
							<div class="matter">
								...
								<ul class="list-inline">
									<li>
										<a href="#"><i class="fa fa-bookmark" aria-hidden="true"></i> Web Developer</a>
									</li>
									<li>
										<a href="#"><i class="fa fa-map-marker" aria-hidden="true"></i> Chandigarh</a>
									</li>
							...
							<button type="button" class="btn btn-info" onclick="location.href='candidate-single-view.php'">VIEW MORE</button>
						</div>
					</div>
					...
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="product-box candidate">
							<div class="image">
								<a href="candidate-grid-view.php">
									<img class="img-responsive" src="images/img2.jpg" alt="img2" title="img2"/>
								</a>	
								<div class="buttons">
									<div class="open-down">
										<button type="button" class="rotate1">
					...
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="product-box candidate">
							<div class="image">
								<a href="candidate-grid-view.php">
									<img class="img-responsive" src="images/img3.jpg" alt="img3" title="img3"/>
								</a>	
								<div class="buttons">
									<div class="open-down">
										<button type="button" class="rotate1">
					...
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="product-box candidate">
							<div class="image">
								<a href="candidate-grid-view.php">
									<img class="img-responsive" src="images/img4.jpg" alt="img4" title="img4"/>
								</a>	
								<div class="buttons">
									<div class="open-down">
										<button type="button" class="rotate1">
					...
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="product-box candidate">
							<div class="image">
								<a href="candidate-grid-view.php">
									<img class="img-responsive" src="images/img5.jpg" alt="img5" title="img5"/>
								</a>	
								<div class="buttons">
									<div class="open-down">
										<button type="button" class="rotate1">
					...
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="product-box candidate">
							<div class="image">
								<a href="candidate-grid-view.php">
									<img class="img-responsive" src="images/img6.jpg" alt="img6" title="img6"/>
								</a>	
								<div class="buttons">
									<div class="open-down">
										<button type="button" class="rotate1">
					...
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="product-box candidate">
							<div class="image">
								<a href="candidate-grid-view.php">
									<img class="img-responsive" src="images/img7.jpg" alt="img7" title="img7"/>
								</a>	
								<div class="buttons">
									<div class="open-down">
										<button type="button" class="rotate1">
					...
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="product-box candidate">
							<div class="image">
								<a href="candidate-grid-view.php">
									<img class="img-responsive" src="images/img8.jpg" alt="img8" title="img8"/>
								</a>	
								<div class="buttons">
									<div class="open-down">
										<button type="button" class="rotate1">
					...
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="product-box candidate">
							<div class="image">
								<a href="candidate-grid-view.php">
									<img class="img-responsive" src="images/img9.jpg" alt="img9" title="img9"/>
								</a>	
								<div class="buttons">
									<div class="open-down">
										<button type="button" class="rotate1">
...
<!-- Mirrored from ocsolutions.co.in/html/jobportal/candidate-grid-view.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Jul 2017 20:48:33 GMT -->
</html>