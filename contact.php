...
<!-- Mirrored from ocsolutions.co.in/html/jobportal/contact.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Jul 2017 20:47:40 GMT -->
<head>
<meta charset="utf-8"/>
							...
							<fieldset>
								<div class="form-group">
									<div class="col-sm-6">
										...
										<input class="form-control" name="first_name" placeholder="Enter your first name" id="input-name" >
									</div>
									<div class="col-sm-6">
										<label>Last Name</label>
										<input class="form-control"  placeholder="last name" name="last_name" maxlength="50">
									</div>
								</div></br>
								<div class="form-group">
									<div class="col-sm-6">
										<label>E-mail</label>
										<input class="form-control" placeholder="Enter your name" id="input-name"  name="email" maxlength="80" >
									</div>
									<div class="col-sm-6">
										<label>Phone Number</label>
										<input class="form-control"  placeholder="phone no" value="" name="telephone" maxlength="30" type="text">
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-sm-12">
										<label>Message</label>
										<textarea class="form-control"  rows="10" name="commeents" maxlength="3000" placeholder="" required=""></textarea>
									</div>
								</div>
								
								
								<div class="button">
									<button type="submit" value="Submit" class="btn btn-primary btnus" ><a href="contact.php">SEND MESSAGE</a></button>
								</div>
							</fieldset>
						</form>
					</div>
					...
					<div class="detail col-md-12">
						...
						<ul class="list-unstyled">
							<li>
								...
								<a href="contact.php"><span>123 Main Street,Anytown,LDH 12345 INDIA</span></a>
							</li>
							<li>
								<h5>Phone</h5>
								<i class="fa fa-phone" aria-hidden="true"></i>
								<a href="contact.php"><span>+1800-123-1234</span></a>
							</li>
							<li>
								<h5>Email</h5>
								<i class="fa fa-envelope" aria-hidden="true"></i>
								<a href="contact.php"><span>Support@jobportal.com</span>
								</a>
							</li>
							<li>
								<h5>Skype</h5>
								<i class="fa fa-skype" aria-hidden="true"></i>
								<a href="contact.php"><span>Jobs.2017</span></a>
							</li>
						</ul>
					</div>
					<!-- detail end here -->
...
<!-- Mirrored from ocsolutions.co.in/html/jobportal/contact.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Jul 2017 20:47:43 GMT -->
</html>