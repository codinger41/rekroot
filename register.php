...
<!-- Mirrored from ocsolutions.co.in/html/jobportal/register.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Jul 2017 20:49:00 GMT -->
<head>
<meta charset="utf-8"/>
			...
			<div class="row">
				<div class="col-sm-offset-2 col-md-8 col-sm-8 col-xs-12">
					<div class="form">
						...
						<form action="UserAccount.php" class="form-horizontal" method="post">
							...
							<fieldset>
								...
								<div class="form-group">
									<div class="col-sm-12">
										...
										<input  type="text" name="skills" placeholder="CODING,TEACHING etc" required="">
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-12">
										<label>Experience</label>
										<input  type="text" name="experience" placeholder="1YEAR, 2YEARS,etc" required="">
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-12">
										<label>Education</label>
										<input  type="text" name="education" placeholder="Bsc Nursing, etc" required="">
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-12">
								...
								<div class="form-group">
									<div class="col-sm-12 confirmation">
										<label>
											<input name="confirmation" value="yes" type="checkbox">By clicking register, I read & accept <a href="#" class="colorLink subHeadingText icon-wrap">the terms</a>
										</label>
								...
								<div class="button">
									<button class="btn btn-primary btnus"  type="submit" name="signupSubmit" value="CREATE ACCOUNT">REGISTER</button>
								</div>
